...
export const LocationForm: React.FC<LocationFormProps> = ({
  ...
  const regionFieldName = `${fieldNamePrefix}region`;
  const districtFieldName = `${fieldNamePrefix}district`;
  ...
  const handleRegionSelect = (region: Region) => {
    ...
    setValue(regionFieldName, region.region, {
      shouldValidate: true,
      shouldDirty: true,
    });
  ...
  const handleDistrictSelect = (district: string) => {
    ...
    setValue(districtFieldName, district, {
      shouldValidate: true,
      shouldDirty: true,
    });
    setIsOpen(false);
