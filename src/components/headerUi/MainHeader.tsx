    ...
    <div className="bg-background/80 backdrop-blur-sm transition-all">
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 py-2 sm:py-4">
        <div className="flex items-center justify-between">
          ...
          {/* Search Section with Enhanced Popover */}
          <div className="hidden md:flex items-center">
            <Popover open={isSearchOpen} onOpenChange={setIsSearchOpen}>
              ...
              <PopoverContent
                ...
                sideOffset={8}
              >
                {regions && <SearchSection regions={regions} />}
              </PopoverContent>
            </Popover>
          </div>

          <div className="flex items-center gap-4">
            <DesktopNavigation session={session} profile={profile} />
        ...
        <MobileHeaderUi isOpen={isMobileMenuOpen} profile={profile} />
      </div>
    </div>
  );
}
